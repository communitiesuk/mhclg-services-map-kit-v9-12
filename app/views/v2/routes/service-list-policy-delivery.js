...
console.log("v2 service-list-policy-delivery.js data:\n");
...
router.get('/v2/service-list-policy-delivery', function (req, res) {
...
//
  ...
  res.render('v2/service-list-policy-delivery', {
