...
console.log("v4 policy-team-services.js data:\n");
...
const gs = require('fs');
const usersfileLocation = './app/views/v4/data/end-users-data.json';
...
router.get('/v4/policy-team-services', function (req, res) {
  ...
  res.render('v4/policy-team-services', {
    focusTeam: focusTeam,
