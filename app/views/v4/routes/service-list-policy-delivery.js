...
console.log("v4 service-list-policy-delivery.js data:\n");
...
router.get('/v4/service-list-policy-delivery', function (req, res) {
...
//
  ...
  res.render('v4/service-list-policy-delivery', {
